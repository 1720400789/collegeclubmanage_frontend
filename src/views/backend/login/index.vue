...
//从store中得到登录接口的响应
const { user_res, admin_flag } = storeToRefs(userStore)
// 3. 获取form实例做统一校验
  ...
  <div>
    <header class="login-header">
      <div class="container m-top-20">
        <h1 class="logo">
          <RouterLink to="/front">社团首页</RouterLink>
        </h1>
    ...
    <footer class="login-footer">
      <div class="container">
        <p>
          ...
          <a href="javascript:;">联系老师</a>
          <a href="javascript:;">搜索推荐</a>
          <a href="javascript:;">友情链接</a>
        </p>
        <p>CopyRight &copy; 高校社团管理系统</p>
      </div>
    </footer>
  </div>
</template>
...
.login-header {
  ...
  .logo {
    ...
    a {
      ...
      width: 100%;
      text-indent: -9999px;
      background: url("@/assets/images/shuanQ.jpg") no-repeat center 18px / contain;
    }
  }
